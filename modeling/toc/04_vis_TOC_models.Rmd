...
most_recent_file <- list.files(here("data", "derived","models", "TOC_realtime", "in_dev"), pattern = "ross_only_toc_xgboost_models_light_.*\\.rds", full.names = TRUE) %>%
  tail(1)
...
```{r}
create_sensor_ts_plot <- function(example_site, complete_sensor_data, water_chem, model, site_title, start_dt, end_dt){
