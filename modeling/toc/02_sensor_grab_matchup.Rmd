...
```{r}
virridy_data <- read_csv(here("data", "derived", "matchup_datasets","parsed_data_virridy.csv"))%>%
  dplyr::select(-"...1" )%>%
...
write_csv(all_matched_data, here("data", "derived", "matchup_datasets", paste0("parsed_toc_sensor_clp_virridy_", Sys.Date(),".csv")))
